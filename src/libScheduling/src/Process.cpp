...
std::string Process::to_string() const {
    return
        _name + ": "
        + visit(
        [](const Printable &state) { return state.to_string(); },
        _state
    );
}
...
string Process::StateCreated::to_string() const {
    return "state: created   ";
}

string Process::StateReady::to_string() const {
    return "state: ready     ";
}
...
string Process::StateRunning::to_string() const {
...
string Process::StateBlocked::to_string() const {
...
string Process::StateTerminated::to_string() const {
